...
- Office hours (change): 
    ...
    - Tuesday 2:20 - 3:30 PM, Leasure 013

    - Thursday 11:15 AM - 12:15 PM Dickens 009C

    - By-appointment / open door policy 
    
    - i.e., Students have taken a liking to 10:00 AM on Friday

- Project proposals

    - Please schedule a meeting with me to review your proposal idea (or attend office hours)

    - If you plan on doing Datafest then you need to provide proof of registration by March 10

    - You don't need data to have a proposal

    - Today we'll go over how to find data a little
